...
function Orcamento() {
  ...
  useEffect(() => {
    if (curso === "BRIGADA" || curso === "NR-33") {
      ...
      let totalComAumento =
        totalTreinamento + (totalTreinamento * formValues.porcentagem) / 100;
      setTotal(totalComAumento.toLocaleString("pt-BR"));
    }
  }, [curso, formValues]);
      ...
      <>
        ...
        <form className={styles.Formulario} onSubmit={handleSubmit}>
          <div className={styles.ContainerForm}>
            ...
            />
            <label htmlFor="">E-mail do Solicitante: </label>
            <input
            ...
            curso === "BRIGADA-NT07" ? (
              <>
                ...
                />
                <label htmlFor="">Extintores</label>
                <input
                  type="number"
            ...
            />
            <label htmlFor="">Porcentagem de Lucro: </label>
            <input
              type="number"
